...
public class LayoutView extends javax.swing.JFrame {
        ...
        sideNavPanelLayout.setHorizontalGroup(
            ...
            .addGroup(sideNavPanelLayout.createSequentialGroup()
                ...
                .addGroup(sideNavPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(manageCustomerButton, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
    ...
    private void loadOderPanel() {
        bodyPanel.removeAll();
        OrderPanel oderPanel = new OrderPanel();
        oderPanel.setSize(bodyPanel.getWidth(), bodyPanel.getHeight());
        bodyPanel.add(oderPanel);
        bodyPanel.repaint();
        bodyPanel.revalidate();
    }
}
